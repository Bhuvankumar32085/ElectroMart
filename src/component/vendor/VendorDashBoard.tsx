...
const VendorDashBoard = () => {
  ...
  return (
    <div className="flex min-h-screen w-full pt-18 bg-[#0b0f1a] text-white overflow-hidden">
      {/*  SIDEBAR  */}
      <motion.aside
      ...
      {/*  MAIN CONTENT  */}
      <div className="flex-1 max-h-screen p-6 md:p-10 no-scrollbar overflow-y-auto pb-20 md:pb-0">
